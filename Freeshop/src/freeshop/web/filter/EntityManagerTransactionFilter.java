...
public class EntityManagerTransactionFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res,
		...
		EntityManagerFactory emf = (EntityManagerFactory) this.context.getAttribute("EntityManagerFactory");
		...
		try {
			...
			ShopGaeJpaDAO.setEntityManager(em);
			...
			ShopGaeJpaDAO.resetEntityManager();
